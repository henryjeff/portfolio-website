...
export default class Renderer {
    ...
    setInstance() {
        ...
        // this.overlayInstance.domElement.style.opacity = '0.1';
        // this.overlayInstance.domElement.style.mixBlendMode = 'multiply';
        // this.overlayInstance.domElement.style.opacity = '0.3';
        // this.overlayInstance.domElement.style.mixBlendMode = 'lighten';
        // this.overlayInstance.domElement.style.opacity = '0.1';
        this.overlayInstance.domElement.style.mixBlendMode = 'soft-light';
        this.overlayInstance.domElement.style.opacity = '0.2';
        // this.overlayInstance.domElement.style.mixBlendMode = 'difference';
        // this.overlayInstance.domElement.style.opacity = '0.1';
        // this.overlayInstance.domElement.style.mixBlendMode = 'exclusion';
        // this.overlayInstance.domElement.style.opacity = '0.1';
